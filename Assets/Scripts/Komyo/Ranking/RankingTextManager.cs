...
public class RankingTextManager : MonoBehaviour
{
    ...
    public void SetText()
    {
        firstName.text = sortDate.ReturnRanking(1).name;
        firstScore.text = sortDate.ReturnRanking(1).score.ToString();
        secondName.text = sortDate.ReturnRanking(2).name;
        secondScore.text = sortDate.ReturnRanking(2).score.ToString();
        thirdName.text = sortDate.ReturnRanking(3).name;
        thirdScore.text = sortDate.ReturnRanking(3).score.ToString();
        fourthName.text = sortDate.ReturnRanking(4).name;
        fourthScore.text = sortDate.ReturnRanking(4).score.ToString();
        fifthName.text = sortDate.ReturnRanking(5).name;
        fifthScore.text = sortDate.ReturnRanking(5).score.ToString();
