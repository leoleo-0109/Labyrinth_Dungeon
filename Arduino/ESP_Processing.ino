...
/* BluetoothSerialを使用する場合は、SerialBT.println(~) ※BT忘れずに */
...
#define OUTPUT_READABLE_YAWPITCHROLL   // ←シリアルモニタで値を確認したいときにコメントアウトを解除する
...
//#define OUTPUT_TEAPOT   // ←Processingを使用する時にコメントアウトを解除する
...
void loop() {
    ...
    if (mpu.dmpGetCurrentFIFOPacket(fifoBuffer)) { // Get the Latest packet 
            ...
            SerialBT.write(teapotPacket, 14);
