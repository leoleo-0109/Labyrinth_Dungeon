// dsgarageのESP32の場合 BluetoothポートはCOM9
// れおっちのESP32の場合 BluetoothポートはCOM10
...
const int FirstButton = 15;   // IO15
const int SecondButton = 0;   // IO0
const int ThirdButton = 16;   // IO16
const int LeftButton = 5;     // IO5
const int RightButton = 19;   // IO19
const int EnterButton = 21;   // IO21
...
void setup()
{
  ...
  pinMode(FirstButton, INPUT_PULLUP);    // IO15
  pinMode(SecondButton, INPUT_PULLUP);   // IO0
  pinMode(ThirdButton, INPUT_PULLUP);    // IO16
  pinMode(LeftButton, INPUT_PULLUP);     // IO5
  pinMode(RightButton, INPUT_PULLUP);    // IO19
  pinMode(EnterButton, INPUT_PULLUP);    // IO21
}
